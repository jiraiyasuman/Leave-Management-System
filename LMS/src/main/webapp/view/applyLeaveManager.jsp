...
<!--heder end here-->
		<!--//content-inner-->
            ...
            <c:if test="${not empty succMsg }">
                ...
                <form action="../applyManager" method="post">
					...
					<div class="row" align="right">
						<div class="col-sm-8 col-sm-offset-4">
							...
							<a href="homeManager.jsp"><button type="button" class="btn btn-default">Cancel</button></a>
						</div>
					</div>
                </form>              
...
<form action="displayManager.jsp" method="post">
		<div class="content" align="center">
