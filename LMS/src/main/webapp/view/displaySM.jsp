...
<title>Senior manager Leave Records</title>
<style>
#footer {
...
<div class="agile-tables" align="center" style="margin-top: 11rem;">
	...
	try{
		...
		String sql="SELECT * FROM leavemanagementsystem.finalleaverecordseniormanager WHERE EMPLOYEE_ID=?;";
	...
	%>
				  ...
				  <a href="manageSeniorManager.jsp">Back</a>
				  </div>
