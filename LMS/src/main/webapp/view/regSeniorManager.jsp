      ...
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            <!-- ***** Logo Start ***** -->
            <a href="#" class="logo">
              <h4 style="color:black, font-size:-12vw;" ><strong>Senior Manager Registration Portal</strong></h4>
            </a>
          </nav>
        </div>
      </div>
...
<form action="../SMRegister" method="post">
...
<input type="password" id="password" placeholder="Password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{7,}"  required><i class="far fa-eye" id="togglePassword" style="margin-left: -30px; cursor: pointer;"></i>
                   ...
                   <a href="loginSeniorManager.jsp">Already have Account?</a>
                </form>
</div>
</div>
<script>
