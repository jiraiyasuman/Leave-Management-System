...
public class EmpLeaveDao implements EmpLeaveDaoRepo {
public static Connection conn=null;
public static ApplyLeaveEmployee a=null;
public EmpLeaveDao(Connection conn)
{
	this.conn=conn;
}
public boolean insert(ApplyLeaveEmployee ah)
{
	...
	try {
		...
		String sql="INSERT INTO `leavemanagementsystem`.`finalleaverecordemployees` (`EMPLOYEE_ID`, `NAME`, `FROM_DATE`, `TO_DATE`,`LEAVE_TYPE`,`NO_OF_DAYS`, `LEAVE_REASON`,`LEAVE_BALANCE`,`STATUS`) VALUES (?, ?, ?, ?, ?, ?, ?,?,?);";
